...
public class VentanaModificarCita extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaModificarCita frame = new VentanaModificarCita();
	 ...
	 * Create the frame.
	 */
	public VentanaModificarCita(Cita c) {
		...
		JLabel lblTitulo = new JLabel("MODIFCAR PACIENTE: ");
	...
	private void cargarValores(Cita c) {
		// TODO Auto-generated method stub
		textFieldDni.setText(c.getDniPaciente());
	}
